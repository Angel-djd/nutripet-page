function AboutPage({ onClose }) {
  return (
    <main className="flex-grow container mx-auto px-4 py-8">
      <button onClick={onClose} className="text-green-600 mb-4 inline-block hover:underline">
        ← Volver al inicio
      </button>
      <h1 className="text-3xl font-bold mb-8 text-green-700">Sobre NutriPet</h1>

      <div className="bg-white rounded-lg shadow-md p-6 space-y-6">
        <section>
          <h2 className="text-2xl font-bold mb-3 text-green-600">Visión</h2>
        ...
        <section>
          <h2 className="text-2xl font-bold mb-3 text-green-600">Misión</h2>
          <p className="text-gray-700">
        ...
        <section>
          <h2 className="text-2xl font-bold mb-3 text-green-600">Valores</h2>
          <ul className="space-y-4">
            <li className="bg-green-50 p-4 rounded-lg">
              <h3 className="font-bold text-green-700">Autenticidad radical</h3>
              <p className="text-gray-600">Transparencia total en cada ingrediente.</p>
            </li>
            <li className="bg-green-50 p-4 rounded-lg">
              <h3 className="font-bold text-green-700">Excelencia consciente</h3>
              <p className="text-gray-600">Máxima calidad con sostenibilidad.</p>
            </li>
            <li className="bg-green-50 p-4 rounded-lg">
              <h3 className="font-bold text-green-700">Innovación valiente</h3>
        ...
        <section>
          <h2 className="text-2xl font-bold mb-3 text-green-600">Objetivos</h2>
